                        ...
                        <form action="{{ route('product.update',$category->id )}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input id="inputText3" name="name" type="text" value="{{ $category->name }}"
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <textarea id="inputText3" name="short_description"
                                        class="form-control @error('short_description') is-invalid @enderror"> value="{{ $category->short_description }}"</textarea>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <textarea id="inputText3" name="description" class="form-control @error('description') is-invalid @enderror"> value="{{ $category->description }}"  </textarea>
                                    @error('description')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <textarea id="inputText3" name="product_details" class="form-control @error('product_details') is-invalid @enderror">  value="{{ $category->product_details }}"</textarea>
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input id="inputText3" name="quantity" type="number" value="{{ $category->quantity }}"
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input id="inputText3" value="{{ $category->price }}" name="price" type="number"
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input id="inputText3" value="{{  $category->discount }}" name="discount" type="number"
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input id="inputText3"value={{  $category->delivery_policy }} name="delivery_policy" type="text"
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input id="inputText3" value={{  $category->return_policy }} name="return_policy" type="text"
                                ...
                                <div class="form-group col-6">
                                    ...
                                    <input id="inputText3" value="{{ $category->order }}" name="order" type="number"
